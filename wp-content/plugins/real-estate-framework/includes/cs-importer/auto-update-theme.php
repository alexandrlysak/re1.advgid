...
if ( ! function_exists('wp_rem_cs_check_for_updates') ) {
	...
	function wp_rem_cs_check_for_updates() {
		...
		if ( ! empty($wp_rem_cs_var_options['wp_rem_cs_var_cs_marketplace_username']) ) {
			...
			$user_name = $wp_rem_cs_var_options['wp_rem_cs_var_cs_marketplace_username'];
			$api_key = $wp_rem_cs_var_options['wp_rem_cs_var_cs_secret_api_key'];
			$skip_backup = $wp_rem_cs_var_options['wp_rem_cs_var_cs_skip_theme_backup'];

			require_once plugin_dir_path(__FILE__) . 'class-envato-api.php';
...
if ( ! function_exists('wp_rem_cs_auto_upgrade_theme_and_plugins') ) {
	...
	function wp_rem_cs_auto_upgrade_theme_and_plugins() {
		global $wp_rem_cs_options, $wp_rem_cs_var_options, $current_screen, $cs_theme_upgraded_name, $cs_plugins_upgraded;
		...
		// Upgrade Theme.
		$theme_info['user_name'] = $wp_rem_cs_var_options['wp_rem_cs_var_cs_marketplace_username'];
		$theme_info['api_key'] = $wp_rem_cs_var_options['wp_rem_cs_var_cs_secret_api_key'];
...
if ( ! function_exists('wp_rem_cs_auto_update_theme') ) {
	...
	function wp_rem_cs_auto_update_theme($theme_info) {
		...
		require_once plugin_dir_path(__FILE__).'class-wp-upgrader.php';
	...
	function wp_rem_cs_auto_update_plugins($plugins) {
		...
		foreach ( $plugins as $key => $plugin_info ) {
			if ( '' != $plugin_info['slug'] ) {
				...
				if( is_array( $cs_plugins_upgraded ) ){
...
if ( ! function_exists('wp_rem_cs_backup_theme') ) {
	...
	function wp_rem_cs_backup_theme($theme) {
		...
		require_once plugin_dir_path(__FILE__).'class-envato-backup.php';
